...
# translate
echo $EXP_NAME
cat $DATA_PATH/sp-cl-EMEA.en-et.docs.test-cl.en \
...
# # de-sentencepiece
python3 scripts-clustering/apply_sentencepiece.py --corpora experiments/res2/hyp_en_et_CLUSTER_0_EMEA.txt --model /gpfs/hpc/projects/nlpgroup/bergamot/da/experiments/EMEA-fix/concat-docs-data/preproc-models/fs-en-et --action restore

python3 scripts-clustering/apply_sentencepiece.py --corpora experiments/res2/cl-EMEA.en-et.docs.test-cl.en --model /gpfs/hpc/projects/nlpgroup/bergamot/da/experiments/EMEA-fix/concat-docs-data/preproc-models/fs-en-et --action restore
